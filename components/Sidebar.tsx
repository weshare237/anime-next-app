  ...
  return (
    <>
      ...
      <div
        ...
        className='fixed z-40 h-fit p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800'
        tabIndex={-1}
        ...
        <div className='py-4 overflow-y-auto'>
          <ul className='space-y-2'>
            ...
            <li>
              <button
                type='button'
                className='flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:text-blue-600 hover:bg-blue-200 hover:dark:bg-blue-900 hover:dark:text-blue-200'
