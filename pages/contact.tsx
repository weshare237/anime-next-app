...
const Contact = () => {
  ...
  const onSubmit: SubmitHandler<IContactFormInput> = async (data) => {
    // setLoading(true)
      ...
      <div className='max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg'>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            {errors.email && (
              <div className='mb-2'>
                <span className='text-red-500'>Please provide full name</span>
              </div>
            )}
          </div>
          <div className='mt-8'>
          ...
          <div className='mt-8'>
            ...
            {errors.email && (
              <div className='mb-2'>
                <span className='text-red-500'>Please provide message</span>
              </div>
            )}
          </div>
          <div className='mt-8'>
